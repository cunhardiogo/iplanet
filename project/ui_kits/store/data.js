// Product fixtures + section data for the iPlanet store mock.
// All copy in pt-BR. Mix of "Zero na caixa" and "Seminovo" inventory.
// Product images are real assets shipped in /assets/products/.
window.iPlanetData = {
  whatsapp: '5511973484819',  // +55 11 97348-4819
  whatsappDisplay: '+55 11 97348-4819',
  ...
  // ZERO NA CAIXA — lacrados, with real Apple product photography
  novidades: [
    {
  ...
  troca: {
    id: 'troca',
    title: 'Tem um Apple antigo? Vira desconto.',
    subtitle: 'Manda foto pelo WhatsApp e a gente te dá uma proposta na hora. Seu iPhone, iPad ou Mac usado vira parte do pagamento do novo.',
    cta1: 'Avaliar pelo WhatsApp',
    cta2: 'Como funciona',
  },

  // ACESSÓRIOS — small carousel
  acessorios: [
